      ...
      for j = 1:nChannels,
         ...
         if alpha ~= 0,
            ...
            ic1(i, j, ff) = pdc(i, j, ff) ...
                    - sqrt(varass1(i, j, ff))*icdf('norm',1-alpha/2.0,0,1);
            ...
            pvalues(i, j, ff) = 1 - cdf('chi2', pdc(i, j, ff)*(patden*2*np), patdf);
            ...
            % nop;
            %     For alpha == 0, statistics are not calculated for faster
            %     PDC computation.
         end;
      end;
   end;
