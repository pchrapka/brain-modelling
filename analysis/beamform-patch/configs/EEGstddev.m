function config_file = EEGstddev(datadir, subject, stimulus)
% EEGSTDDEV creates a subject specific config for ftb.EEG
%   EEGSTDDEV(datadir, subject, stimulus) creates a subject specific config
%   for ftb.EEG
%
%   Input
%   -----
