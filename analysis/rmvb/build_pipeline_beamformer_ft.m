function pipeline = build_pipeline_beamformer_ft(params_subject,pipedir)
%BUILD_PIPELINE_BEAMFORMER_FT builds a pipeline for ftb.Beamformer
%   BUILD_PIPELINE_BEAMFORMER_FT(params_subject, pipedir) builds an
...
%           bf      containing options for ftb.Beamformer
%
...
param_list(k).class = 'Beamformer';
param_list(k).prefix = 'BF';
k = k+1;
