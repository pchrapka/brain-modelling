...
for i=1:length(params)
    ...
    if p.Results.flag_tune
        ...
        ngamma = length(params(i).gamma);
        nlambda = length(params(i).lambda);
        norder = length(params(i).order);
        ...
        elseif (ngamma == 1) && (nlambda == 1) && (norder > 1)
            ...
            order_opt = tune_lattice_filter_order(...
                ...
                'order',params(i).order,...
                'lambda_opt',params(i).lambda,...
                'gamma_opt',params(i).gamma,...
                'run_options',run_options,...
                'criteria_samples',params(i).criteria_samples,...
                'plot_order',true);
