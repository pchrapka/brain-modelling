...
% data = loadfile('output/vrc-coupling0-fixed-c4-s1-BurgVectorWindow-C4-P10-W60.mat');
data = loadfile('output/vrc-coupling0-fixed-c4-s1-BurgVector-C4-P10-N1000.mat');
