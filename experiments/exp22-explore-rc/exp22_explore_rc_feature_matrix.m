...
% filter_params = 'params_lf_MCMTQRDLSL1_mt5_p10_l099_n400';
% filter_params = 'params_lf_MCMTQRDLSL1_mt5_p10_l098_n400';
% filter_params = 'params_lf_MCMTQRDLSL1_mt5_p10_l09_n400';
% filter_params = 'params_lf_MLOCCDTWL_p10_l099_n400'; % TODO 
% filter_params = 'params_lf_MLOCCDTWL_p10_l098_n400'; % TODO
...
save_tag = strrep(['mean-' filter_params '-' param_file],'_','-');
save_fig_exp(mfilename('fullpath'),'tag',save_tag);

figure('Position', [100, 100, 600, 800])
plot_rc_feature_matrix(data,'mode','median');
save_tag = strrep(['median-' filter_params '-' param_file],'_','-');
save_fig_exp(mfilename('fullpath'),'tag',save_tag);

figure('Position', [100, 100, 600, 800])
plot_rc_feature_matrix(data,'mode','std');
save_tag = strrep(['std-' filter_params '-' param_file],'_','-');
save_fig_exp(mfilename('fullpath'),'tag',save_tag);

figure('Position', [100, 100, 600, 800])
plot_rc_feature_matrix(data,'mode','diff-mean');
save_tag = strrep(['diff-mean-' filter_params '-' param_file],'_','-');
save_fig_exp(mfilename('fullpath'),'tag',save_tag);

figure('Position', [100, 100, 600, 800])
plot_rc_feature_matrix(data,'mode','diff-median');
save_tag = strrep(['diff-median-' filter_params '-' param_file],'_','-');
save_fig_exp(mfilename('fullpath'),'tag',save_tag);
