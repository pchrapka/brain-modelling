function run_lattice_benchmark(script_name,varargin)
...
%   ----------
%   name (string)
%       benchmark name, used for output files for specific experiment name
%
%       this allows you to run multiple benchmarks with different
%       parameters in the same folder without overwriting/mixing results
...
[expdir,~,ext] = fileparts(script_name);
if isempty(ext)
