classdef MLOCCD_TWL2
    %MOCCD_TWL2 Multichannel Lattice Online Cyclic Coordinate Descent Time Weighted Lasso
    ...
    methods
        function obj = MLOCCD_TWL2(channels,order,varargin)
            %MLOCCD_TWL2
            %   MLOCCD_TWL2(channels,order,...)
            %   
            %   Inputs
            %   ------
            %   channels
