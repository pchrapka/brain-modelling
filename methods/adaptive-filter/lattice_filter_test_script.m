...
lattice_filter_test('MQRDLSL1','filter_args',{lambda}); % fix Kb
lattice_filter_test('MQRDLSL2','filter_args',{lambda}); % fix Kb
lattice_filter_test('MCMTQRDLSL1','filter_args',{trials,0.99}); % fix Kb
lattice_filter_test('MLOCCD_TWL','filter_args',{'lambda',lambda,'gamma',gamma}); % fix everything
lattice_filter_test('MLOCCD_TWL2','filter_args',{'lambda',lambda,'gamma',gamma}); % fix everything
